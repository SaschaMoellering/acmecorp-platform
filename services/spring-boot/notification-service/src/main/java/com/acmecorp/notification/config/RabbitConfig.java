...
public class RabbitConfig {
    ...
    public Declarables notificationTopology(Queue notificationsQueue,
        ...
        return new Declarables(
                ...
                BindingBuilder.bind(notificationsQueue).to(notificationsExchange).with(ROUTING_KEY),
                BindingBuilder.bind(notificationsDeadLetterQueue).to(notificationsDeadLetterExchange).with(DLQ_ROUTING_KEY)
        );
    }

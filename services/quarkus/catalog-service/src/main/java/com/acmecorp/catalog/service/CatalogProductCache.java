...
public class CatalogProductCache {
    ...
    public void put(Product product) {
        ...
        try {
            String serialized = objectMapper.writeValueAsString(CachedProduct.from(product));
            stringCommands.set(cacheKey, serialized, new SetArgs().ex(cacheProperties.productTtl()));
    ...
    public void invalidate(UUID productId) {
        deleteQuietly(productKey(productId));
    }

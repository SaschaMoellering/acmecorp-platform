...
Method["<b>Metric</b><br/>Container memory snapshot after readiness<br/>Collected from docker stats via bench/collect.sh<br/>Minimum: 1 cold starts per Java version"]:::metric

J11["<b>Java 11</b><br/>Memory snapshot median: 560.7 MiB"]:::java11
J17["<b>Java 17</b><br/>Memory snapshot median: 444.2 MiB"]:::java17
J21["<b>Java 21</b><br/>Memory snapshot median: 434.8 MiB"]:::java21

Data["<b>Data Source</b><br/>bench/results/&lt;branch&gt;/&lt;timestamp&gt;/containers.json"]:::component
Status["<b>Status</b><br/>Median of 1 cold starts per Java version"]:::metric
